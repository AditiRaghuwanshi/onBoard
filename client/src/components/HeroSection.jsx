...
const HeroSection = () => {
    ...
    return (
        ...
        // <div className="relative overflow-hidden pt-16 bg-gradient-to-br from-[#00040A] to-[#001636] min-h-screen text-white px-6 py-16">
         <div className="relative overflow-hidden pt-16 bg-gradient-to-br bg-gradient-to-br from-gray-400  to-brown-900 min-h-screen text-white px-6 py-16">
            {/* Gradient Background */ }
            <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30 pointer-events-none"></div>
             ...
             <motion.h1
className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 text-center tracking-tight leading-tight bg-gradient-to-r from-blue-900 to-gray-800 bg-clip-text text-transparent"
                initial={ { opacity: 0, scale: 0.85 } }
                whileInView={ { opacity: 1, scale: 1 } }
                transition={ { duration: 0.7 } }
                viewport={ { once: true } }
            >
              Onboard – Your Shortcut to Success.
